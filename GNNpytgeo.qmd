...
où
  ...
  - `num_test` permet de choisir la proportion de données dans le jeu de test,
  - `num_val` permet de choisir la proportion de données dans le jeu de validation,
...
Pour le test, on ajoute les arêtes du jeu validation au jeu d'entraînement pour faire les convolutions.
...
on s'aperçoit d'une incohérence sur les non-arêtes car nous obtenons des indices de nœuds strictement supérieurs aux nombres de nœuds en ligne ou en colonne...
