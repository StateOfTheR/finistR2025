...
Le code qui suit correspond à l'application des informations disponibles dans la [documentation de torch](https://docs.pytorch.org/docs/stable/notes/extending.html#extending-torch-autograd) sur notre fonction example. Un autre tutoriel intéressant est [le suivant](https://apxml.com/courses/advanced-pytorch/chapter-1-pytorch-internals-autograd/custom-autograd-functions).
...
Plus d'info sur le JIT dans `pytorch` sont disponibles dans [cette documentation](https://docs.pytorch.org/docs/stable/jit.html).
