...
View at:
https://test.pypi.org/project/ammonia-predict-3/0.1.0/
```

The package is now available here: [https://test.pypi.org/project/ammonia-predict-3/0.1.0/](https://test.pypi.org/project/ammonia-predict-3/0.1.0/)
...
```bash
(venv) package_test: pip install -i https://test.pypi.org/simple/ ammonia-predict-3==0.1.0
```
