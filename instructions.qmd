...
Avec clés SSH :
`git clone git@github.com:git@github.com:StateOfTheR/finistR2025.git`
...
[Lien vers la fiche pense-bête](https://docs.docker.com/get-started/docker_cheatsheet.pdf)

[Vers d'autres ressources utiles](https://dockerlabs.collabnix.com/docker/cheatsheet/)
